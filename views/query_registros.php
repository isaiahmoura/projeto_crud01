...
<?php if(count($get_registros_query) > 0): ?>
    <div class="crud">
        ...
        <?php foreach($get_registros_query as $registro): ?>
...
<?php else: ?>
    <div class="crud home">
        <h1>Sua pesquisa não teve nenhum resultado :(</h1>
        <img src="<?php echo BASE_URL; ?>assets/images/sad.png" alt="">
    </div>
<?php endif;?>